...
export const STATIC_I18N_KEYS = [
  ...
  // Leaderboard constants (board tabs, tier names, purchase errors)
  'Usage Board',
  'Tier Board',
  'All Time',
  'Iron',
  ...
  'Grandmaster',
  'Challenger',
  'An order is already being processed. Please try again later.',
  'Too many requests. Please try again later.',
  'Automatic charging is not configured.',
  'Charge failed',
  'Join Daily Board',
  'Join Weekly Board',
  'Join Monthly Board',
  ...
  'Join Tier Board',
  'Show Tier Badge',
  "Hidden from today's usage board when off",
  'Hidden from the weekly board when off',
  "Hidden from this month's usage board when off",
  'Hidden from the all-time board when off',
  'Hidden from the tier board when off',
  'Show next to your anonymous name',
  'Champion',
  'TOP 2',
  'TOP 3',

  // Sponsorship constants (status labels, charge errors)
  'Processing',
  'Completed',
  'Failed',
  'Needs review',
  'Sponsorship failed',
  'Insufficient balance or amount out of range',
  'Sponsorship request was rejected',
  'That request number is already in use',

  // Rename cost labels (RENAME_COST_LABEL_KEY)
  'Free rename',
  'Rename card',
  'Unlimited',

  // Postpaid credit constants (grant/event status labels, apply errors).
  // 'Processing', 'Completed', 'Failed' and 'Needs review' are registered above.
  'In use',
  'Settled',
  'Repaid',
  'Overdue',
