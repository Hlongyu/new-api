...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/users/:id/custom-subscriptions", controller.AdminCreateCustomSubscription)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/:id/reset-rate-limits", middleware.CriticalRateLimit(), controller.ResetTokenRateLimits)
		...
		dataRoute.GET("/groups", middleware.AdminAuth(), controller.GetAllGroupQuotaDates)
		dataRoute.GET("/groups/self", middleware.UserAuth(), controller.GetUserGroupQuotaDates)
