...
type Token struct {
	...
	FiveHourQuota      int            `json:"five_hour_quota" gorm:"default:0"`
	...
	QuotaOverage       int            `json:"quota_overage" gorm:"default:0"`
...
func (token *Token) Update() (err error) {
	err = DB.Model(token).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota",
		"five_hour_quota", "daily_quota", "weekly_quota", "quota_overage",
