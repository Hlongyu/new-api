...
func InitOptionMap() {
	...
	common.OptionMap[setting.UserRequestLimitsOptionKey] = setting.UserRequestLimitsJSON()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case setting.UserRequestLimitsOptionKey:
		err = setting.UpdateUserRequestLimits(value)
