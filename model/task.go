...
type TaskPrivateData struct {
	...
	BillingStartedAt int64               `json:"billing_started_at,omitempty"`
...
type TaskBillingContext struct {
	...
	CouponId           int                `json:"coupon_id,omitempty"`         // 请求提交时冻结的优惠券
	CouponName         string             `json:"coupon_name,omitempty"`
	CouponRatio        float64            `json:"coupon_ratio,omitempty"`
	OriginalGroupRatio float64            `json:"original_group_ratio,omitempty"`
	CouponActiveUntil  int64              `json:"coupon_active_until,omitempty"`
}
